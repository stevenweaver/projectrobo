...
#define PID_RIGHT_INPUT_MAX  255
#define PID_RIGHT_OUTPUT_MIN -10
#define PID_RIGHT_OUTPUT_MAX 10
#define PID_LEFT_INPUT_MIN  0
#define PID_LEFT_INPUT_MAX  255
#define PID_LEFT_OUTPUT_MIN -8
#define PID_LEFT_OUTPUT_MAX 8
...
//StartTime = millis();
 ...
 previous_clicks_LEFT = 0;
  ...
  PID_LEFT.SetSampleTime(300);
  Speed = 40; // ticks per unit time
}
